...
def display_type_instructions(instructions_folder):
    instruction_image_path = Path(instructions_folder) / "Instructions_Type.png"
    instructions = stimuli.Picture(str(instruction_image_path))
    instructions.scale_to_fullscreen()
    instructions.present()
    
def display_write_instructions(instructions_folder):
    instruction_image_path = Path(instructions_folder) / "Instructions_Write.png"
    instructions = stimuli.Picture(str(instruction_image_path))
    instructions.scale_to_fullscreen()
    instructions.present()
...
output_modality = next(trial.get_factor('Output Modality') for trial in b.trials if trial.get_factor('Output Modality') != 'Speech')
if output_modality == 'Write':
    display_write_instructions(Path(instruction_image_folder))
    print("Write instructions")
elif output_modality == 'Type':
    display_type_instructions(Path(instruction_image_folder))
